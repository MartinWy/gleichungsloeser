...
\noindent Gleichung: \texttt{y}\texttt{/}\texttt{a}\texttt{=}\texttt{B}\texttt{\textasciicircum{}(2*}\texttt{x}\texttt{-1)} \hfill Zielvariable: \texttt{x} \hfill Profil: \texttt{standard}

\vspace{8mm}
\begin{center}
\begin{tikzpicture}[x=1em,y=-1em]
\node[anchor=base, inner sep=0pt] at (9.2,2.7) {$\pFourCell{5.04}{B^{{\scriptstyle 2\cdot{}x-1}}}$};
\node[anchor=base, inner sep=0pt] at (2.9,2.7) {$\pFourFraction{1.8em}{\makebox[1.8em][c]{\ensuremath{\pFourCell{0.9}{y}}}}{\makebox[1.8em][c]{\ensuremath{\pFourCell{0.9}{a}}}}$};
\node[anchor=base, inner sep=0pt] at (4.99,2.7) {$\pFourCell{1.62}{=}$};
\node[anchor=base, inner sep=0pt] at (2.9,6.78) {$\pFourFraction{1.8em}{\makebox[1.8em][c]{\ensuremath{\pFourCell{0.9}{y}}}}{\makebox[1.8em][c]{\ensuremath{\pFourCell{0.9}{a}}}}$};
\node[anchor=base, inner sep=0pt] at (0.81,6.78) {$\pFourCell{1.62}{\pFourCell{1.62}{\log_{B}}}$};
\node[anchor=base, inner sep=0pt] at (1.81,6.78) {$\pFourCell{0.38}{\left(\rule[-1em]{0pt}{1.96em}\right.}$};
\node[anchor=base, inner sep=0pt] at (3.99,6.78) {$\pFourCell{0.38}{\left.\rule[-1em]{0pt}{1.96em}\right)}$};
\node[anchor=base, inner sep=0pt] at (4.99,6.78) {$\pFourCell{1.62}{=}$};
\node[anchor=base, inner sep=0pt] at (6.24,6.78) {$\pFourCell{0.88}{2}$};
\node[anchor=base, inner sep=0pt] at (9.71,6.78) {$\pFourCell{4.02}{x}$};
\node[anchor=base, inner sep=0pt] at (12.11,6.78) {$\pFourCell{0.78}{-}$};
\node[anchor=base, inner sep=0pt] at (12.94,6.78) {$\pFourCell{0.88}{1}$};
\end{tikzpicture}
\end{center}
