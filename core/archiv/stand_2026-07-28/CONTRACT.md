...
- Mit `options.projectionEngine = "neukern_adapter"` nutzt `solve()` bereits die opt-in Bruecke in den neuen P4-Kern und adaptiert dessen Ergebnis auf den bisherigen Exportvertrag.
