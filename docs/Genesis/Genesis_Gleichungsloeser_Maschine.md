...
21. Bridge B uebernimmt die komplette neue `FUNCTION`-Huelle einschliesslich Name, optionaler Basis, beider Klammern, Argumentbereich und Shell-Spanne aus der exakt ausgerichteten ersten A2-Projektionszeile. B darf die Kopf- oder Klammerzellen nicht aus der Breite des durchgereichten Inhalts neu berechnen.
