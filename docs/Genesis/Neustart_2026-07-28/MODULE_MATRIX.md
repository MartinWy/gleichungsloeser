...
| Vercel-Containervertrag | `deployment/vercel_container/README.md` | `vercel.json`, `Dockerfile.vercel` | `vercel_container_contract.test.js` | HTTP-Inhalte veraendern; Anwendungsrouten raten; Core-, Cockpit- oder Renderlogik uebernehmen |
...
zusaetzlich, dass ein algebraischer Wiedereintritt keine fruehere
Bruchbelegung verbreitert.
