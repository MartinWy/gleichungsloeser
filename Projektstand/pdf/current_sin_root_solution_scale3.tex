...
\node[anchor=base, inner sep=0pt] at (32.88,12.075) {$\pFourCell{3}{\arcsin\left(5\right)}$};
...
\node[anchor=base, inner sep=0pt] at (32.88,15.535) {$\pFourCell{3}{\arcsin\left(5\right)}$};
...
\node[anchor=base, inner sep=0pt] at (32.88,18.355) {$\pFourCell{3}{\arcsin\left(5\right)}$};
