...
\node[anchor=base, inner sep=0pt] at (12.06,2.9) {$\pFourCell{7.68}{\sqrt{\displaystyle\frac{\pFourCell{2.7}{x}\pFourCell{2.34}{+}\pFourCell{2.64}{3}}{\pFourCell{2.7}{2}\pFourCell{2.34}{+}\pFourCell{2.64}{1}}}}$};
...
\node[anchor=base, inner sep=0pt] at (26.04,7.65) {$\pFourCell{6.12}{\arcsin}$};
\node[anchor=base, inner sep=0pt] at (29.67,7.65) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{5}}\right.}$};
\node[anchor=base, inner sep=0pt] at (39.09,7.65) {$\pFourCell{1.14}{\left.\vphantom{\pFourCell{3}{5}}\right)}$};
...
\node[anchor=base, inner sep=0pt] at (30.81,12.075) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{\arcsin\left(5\right)}}\right.}$};
\node[anchor=base, inner sep=0pt] at (36.45,12.075) {$\pFourCell{4.14}{\left.\vphantom{\pFourCell{3}{\arcsin\left(5\right)}}\right)^{2}}$};
\node[anchor=base, inner sep=0pt] at (26.04,12.075) {$\pFourCell{6.12}{\arcsin}$};
\node[anchor=base, inner sep=0pt] at (29.67,12.075) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{5}}\right.}$};
\node[anchor=base, inner sep=0pt] at (39.09,12.075) {$\pFourCell{1.14}{\left.\vphantom{\pFourCell{3}{5}}\right)}$};
...
\node[anchor=base, inner sep=0pt] at (30.81,15.535) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{\arcsin\left(5\right)}}\right.}$};
\node[anchor=base, inner sep=0pt] at (36.45,15.535) {$\pFourCell{4.14}{\left.\vphantom{\pFourCell{3}{\arcsin\left(5\right)}}\right)^{2}}$};
\node[anchor=base, inner sep=0pt] at (26.04,15.535) {$\pFourCell{6.12}{\arcsin}$};
\node[anchor=base, inner sep=0pt] at (29.67,15.535) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{5}}\right.}$};
\node[anchor=base, inner sep=0pt] at (39.09,15.535) {$\pFourCell{1.14}{\left.\vphantom{\pFourCell{3}{5}}\right)}$};
...
\node[anchor=base, inner sep=0pt] at (30.81,18.355) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{\arcsin\left(5\right)}}\right.}$};
\node[anchor=base, inner sep=0pt] at (36.45,18.355) {$\pFourCell{4.14}{\left.\vphantom{\pFourCell{3}{\arcsin\left(5\right)}}\right)^{2}}$};
\node[anchor=base, inner sep=0pt] at (26.04,18.355) {$\pFourCell{6.12}{\arcsin}$};
\node[anchor=base, inner sep=0pt] at (29.67,18.355) {$\pFourCell{1.14}{\left(\vphantom{\pFourCell{3}{5}}\right.}$};
\node[anchor=base, inner sep=0pt] at (39.09,18.355) {$\pFourCell{1.14}{\left.\vphantom{\pFourCell{3}{5}}\right)}$};
...
\draw[blue!22, line width=0.28pt] (29.1,0.35) -- (29.1,20.19);
...
\draw[blue!22, line width=0.28pt] (38.52,0.35) -- (38.52,20.19);
...
\draw[gray!35, dotted] (26.04,0.35) -- (26.04,20.19);
\node[font={\ttfamily\scriptsize}, text=gray!70, anchor=base] at (26.04,0) {fn7};
\draw[gray!35, dotted] (29.67,0.35) -- (29.67,20.19);
\node[font={\ttfamily\scriptsize}, text=gray!70, anchor=base] at (29.67,0) {fl7};
\draw[gray!35, dotted] (30.81,0.35) -- (30.81,20.19);
\node[font={\ttfamily\scriptsize}, text=gray!70, anchor=base] at (30.81,0) {pl7};
\draw[gray!35, dotted] (32.88,0.35) -- (32.88,20.19);
\node[font={\ttfamily\scriptsize}, text=gray!70, anchor=base] at (32.88,0) {7};
\draw[gray!35, dotted] (36.45,0.35) -- (36.45,20.19);
\node[font={\ttfamily\scriptsize}, text=gray!70, anchor=base] at (36.45,0) {pr7};
\draw[gray!35, dotted] (39.09,0.35) -- (39.09,20.19);
\node[font={\ttfamily\scriptsize}, text=gray!70, anchor=base] at (39.09,0) {fr7};
